...
public class HttpManagerBuilder {
    ...
    public final void init() {
        ...
        if (mainResourceFactory instanceof AnnotationResourceFactory arf) {
    ...
    private void initAnnotatedResourceFactory() {
        ...
        try {
            if (getMainResourceFactory() instanceof AnnotationResourceFactory arf) {
    ...
    private Object createObject(Class c) throws CreationException {
        ...
        for (Method m : c.getMethods()) {
            ...
            if (anno != null) {
                ...
                } catch (CreationException | InvocationTargetException | IllegalArgumentException |
                         IllegalAccessException creationException) {
                    throw new CreationException(m, c, creationException);
                }
            }
        }
        if (created instanceof InitListener l) {
            if (listeners == null) {
