	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			if(settings.directionNav){
				slider.append('<div class="nivo-directionNav"><a class="nivo-prevNav"><img src="templates/images/homepage/arrowLHS.png" /></a><a class="nivo-nextNav"><img src="templates/images/homepage/arrowRHS.png" /></a></div>');
