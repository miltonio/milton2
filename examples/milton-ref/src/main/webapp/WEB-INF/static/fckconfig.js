...
var _FileBrowserLanguage	= 'ettrema' ;	// asp | aspx | cfm | lasso | perl | php | py
var _QuickUploadLanguage	= 'ettrema' ;	// asp | aspx | cfm | lasso | php


// Don't care about the following line. It just calculates the correct connector
// extension to use for the default File Browser (Perl uses "cgi").
var _FileBrowserExtension = "html";


FCKConfig.LinkBrowser = true ;
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Connector=connectors/ettrema/connector.html';
